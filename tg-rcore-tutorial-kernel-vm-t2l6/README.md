...
- crate 名称：`rosist-sallina-tg-rcore-tutorial-kernel-vm-t2l6`
- crate 版本：`0.0.1-preview.1`
- 服务章节：`rosist-sallina-tg-rcore-tutorial-T2L6`
- 仓库地址：`https://github.com/Rosist-Sallina/tg-rcore-tutorial`
- 仓库页面：`https://github.com/Rosist-Sallina/tg-rcore-tutorial/tree/test/tg-rcore-tutorial-kernel-vm-t2l6`
- 建议 tag：`rosist-sallina-tg-rcore-tutorial-kernel-vm-t2l6-v0.0.1-preview.1`

这个 crate 基于官方 `tg-rcore-tutorial-kernel-vm` 扩展了 `T2L6/ch9` 需要的单页页表 helper，例如按 `vpn` 查询/修改 PTE、单页 map/unmap 与局部 `sfence.vma`。
